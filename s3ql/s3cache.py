...
class S3Cache(object):
    ...
    * read or write at the wrong position, if a different thread has
    ...
    :fs:          The parent fs object, provides access to filesystem parameters
                  and db cursors.
    ...
    def __init__(self, fs, cachedir, cachesize):
